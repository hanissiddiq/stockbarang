    ...
    if ($result->num_rows === 1) {         
        ...
        if ($password === $user['password']) {             
            ...
            echo "<script>
                    ...
                    setTimeout(function() {
                        window.location.href = '" . ($user['posisi'] === 'pemilik' ? 'index.php' : 'operator.php') . "';
                    }, 500);
                  </script>";
            exit;          
        } else {
...
<head>
    ...
    <style>
    body {
        background-image: url('9bbbb.JPG'); /* Ganti sesuai path gambar */
...
<body>
    <div class="welcome-text">Selamat Datang di Website Informasi Persediaan Barang <br><span style="font-size: 1.5rem;">Toko Barokah</span></div>
                        ...
                        <div class="col-lg-5">
                            <div class="card shadow-lg border-0 rounded-lg mt-4">
                                <div class="card-header  text-white">
                                    <h3 class="text-center"> <div class="sb-nav-link-icon"><i class="fas fa-user-alt"></i></div></h3>
                                </div>
                                <div class="card-body">
                                    <form method="post">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mt-4">
                                            ...
                                            <button class="btn btn-primary w-50" onclick="window.location.href='daftar.php'; return false;">Daftar</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
